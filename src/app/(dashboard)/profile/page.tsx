...
export default async function ProfilePage() {
  ...
  return (
    <div className="space-y-8 max-w-6xl mx-auto relative">
      ...
      <div className="relative rounded-3xl bg-zinc-900 border border-zinc-800 overflow-hidden shadow-2xl p-6 md:p-10">
        <div className="absolute inset-0 bg-gradient-to-r from-emerald-500/5 to-transparent pointer-events-none" />
        <div className="flex flex-col md:flex-row items-center gap-6 md:gap-8 relative z-10">
          <div className="relative group shrink-0">
            <div className="h-24 w-24 md:h-32 md:w-32 rounded-3xl bg-gradient-to-br from-emerald-400 to-emerald-600 flex items-center justify-center shadow-2xl shadow-emerald-500/20 outline outline-4 outline-zinc-900 ring-1 ring-zinc-800">
              <span className="font-black text-zinc-950 text-3xl md:text-5xl tracking-tighter">{initials}</span>
            </div>
            <div className="absolute -bottom-2 -right-2 h-8 w-8 rounded-xl bg-zinc-950 border border-zinc-800 flex items-center justify-center text-emerald-500">
          ...
          <div className="text-center md:text-left flex-1 space-y-2">
            <div className="flex flex-col md:flex-row md:items-center gap-3 justify-center md:justify-start">
              ...
              <span className="self-center inline-flex items-center px-3 py-1 rounded-full text-[10px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/20">
                {user.role}
              </span>
            </div>
      ...
      <div className="grid gap-6 md:grid-cols-12">
          ...
          <div className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
            ...
            <div className="p-6 space-y-5">
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-white bg-zinc-950 border border-zinc-800/80 px-4 py-3 rounded-xl">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-white bg-zinc-950 border border-zinc-800/80 px-4 py-3 rounded-xl flex items-center gap-2">
              ...
              <div className="space-y-1">
                ...
                <p className="text-sm font-bold text-white bg-zinc-950 border border-zinc-800/80 px-4 py-3 rounded-xl flex items-center gap-2">
                  ...
                  <span className="font-black italic uppercase text-emerald-400">{user.role}</span>
                </p>
              </div>

              <div className="space-y-1">
                <span className="text-[10px] font-black uppercase tracking-widest text-zinc-500">System Integration Status</span>
                <div className="flex items-center gap-2 bg-zinc-950 border border-zinc-800/80 px-4 py-3 rounded-xl">
                  <div className="h-2 w-2 rounded-full bg-emerald-500 animate-pulse" />
                  <span className="text-xs font-bold text-emerald-500 uppercase tracking-widest">Active & Operational</span>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="md:col-span-7 space-y-6">
          ...
          {user.role === 'ADMIN' && systemStats && (
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl space-y-6">
              <div className="p-6 border-b border-zinc-800 bg-zinc-950/20 flex items-center justify-between">
                ...
                <span className="text-[9px] font-black uppercase tracking-widest bg-orange-500/10 text-orange-400 border border-orange-500/20 px-2 py-0.5 rounded">Superuser Node</span>
              </div>
              ...
              <div className="p-6 space-y-6">
                <div className="grid gap-4 grid-cols-1 sm:grid-cols-3">
                  ...
                  <div className="bg-zinc-950 border border-zinc-800 p-4 rounded-2xl text-center">
                    ...
                    <p className="text-2xl font-black text-white italic">{systemStats.activePlans}</p>
                  </div>
                </div>
              ...
              {user.ownedVendor ? (
                <div className="bg-zinc-900 border border-zinc-800 rounded-3xl overflow-hidden shadow-2xl">
                  <div className="p-6 border-b border-zinc-800 bg-zinc-950/20 flex items-center justify-between">
                    ...
                    <span className="text-[9px] font-black uppercase tracking-widest bg-emerald-500/10 text-emerald-400 border border-emerald-500/20 px-2.5 py-0.5 rounded-full">
                  ...
                  <div className="p-6 space-y-6">
                    <div className="flex flex-col sm:flex-row items-center gap-4 p-4 rounded-2xl bg-zinc-950 border border-zinc-800/80">
                      {user.ownedVendor.logoUrl ? (
                        ...
                        <div className="h-16 w-16 rounded-xl bg-zinc-900 border border-zinc-800 flex items-center justify-center text-emerald-500 shrink-0">
                          <Store size={24} />
                        </div>
                      )}
                      <div className="text-center sm:text-left flex-1">
                        <h4 className="text-lg font-black text-white uppercase italic tracking-tighter leading-none">{user.ownedVendor.businessName}</h4>
                    ...
                    <div className="grid gap-4 sm:grid-cols-2">
                      <div className="bg-zinc-950 border border-zinc-800 p-4 rounded-2xl space-y-1">
                        <span className="text-[9px] font-black text-zinc-600 uppercase tracking-widest">Business Hotline</span>
                    ...
                    <div className="bg-zinc-950 border border-zinc-800 rounded-2xl p-5 space-y-3">
                      <div className="flex items-center justify-between">
                        ...
                        <span className="text-[9px] font-bold text-emerald-500 uppercase tracking-widest bg-emerald-500/10 border border-emerald-500/20 px-2 py-0.5 rounded">
                ...
                <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-10 text-center space-y-6">
                  <div className="h-16 w-16 rounded-full bg-zinc-950 border border-zinc-800 flex items-center justify-center text-zinc-500 mx-auto">
                    <Store size={32} />
                  </div>
                  <div className="space-y-2">
                    <h3 className="text-lg font-black text-white uppercase italic tracking-tighter">No Vendor Profile Synced</h3>
          ...
          {user.role !== 'ADMIN' && user.role !== 'VENDOR_OWNER' && (
            <div className="bg-zinc-900 border border-zinc-800 rounded-3xl p-10 text-center space-y-6">
              ...
              <div className="space-y-2">
                <h3 className="text-lg font-black text-white uppercase italic tracking-tighter">Standard Access Workspace</h3>
                <p className="text-xs text-zinc-500 font-bold uppercase tracking-widest max-w-sm mx-auto leading-relaxed">
